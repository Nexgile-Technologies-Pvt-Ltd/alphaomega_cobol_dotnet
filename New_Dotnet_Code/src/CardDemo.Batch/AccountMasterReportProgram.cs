...
/// the assembler subroutine <c>COBDATFT</c> (re-implemented as <see cref="DateFormatConverter"/>).
/// </summary>
/// <remarks>
...
/// </list></para>
/// </remarks>
public sealed class AccountMasterReportProgram
{
    ...
    {
        var program = new AccountMasterReportProgram(account, outFilePath, arryFilePath, vbrcFilePath, host);
        program.Execute();
    ...
    private void PopulateAccountRecord() // COBOL paragraph: 1300-POPUL-ACCT-RECORD
    {
        ...
        DateFormatConverter.Convert(codatecn, _host);
