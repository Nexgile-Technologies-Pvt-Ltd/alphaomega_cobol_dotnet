...
/// statement driver <see cref="StatementGenerationProgram"/> calls for every read/open/close. The mainframe program is a
...
/// </remarks>
public sealed class StatementFileAccessor
{
    ...
    public static StatementFileAccessor Create(BatchSupport support, HostKind host = HostKind.Ebcdic)
    ...
    public static StatementFileAccessor Create(RelationalDb db, HostKind host = HostKind.Ebcdic)
