...
public sealed class Cobtupdt
{
    ...
    private Cobtupdt(RelationalDb db, IReadOnlyList<string> inputRecords)
    {
        _db = db;
    ...
    {
        var program = new Cobtupdt(db, inputRecords);
        program.Execute();
    ...
    /// </summary>
    public static Cobtupdt Create(RelationalDb db, IReadOnlyList<string> inputRecords)
        => new(db, inputRecords);
