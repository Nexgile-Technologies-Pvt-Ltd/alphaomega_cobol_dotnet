...
/// <item><b>CALL 'CBSTM03B'</b> for all I/O (here <see cref="Cbstm03b.Call"/>), and <b>CALL 'CEE3ABD'</b>
...
public sealed class Cbstm03a
{
    ...
    private readonly Cbstm03b.M03BArea _m03b = new();
    ...
    private Cbstm03a(Cbstm03b io, HostKind host)
    {
        _io = io;
        _host = host;
    }
    ...
    {
        var program = new Cbstm03a(Cbstm03b.Create(support, host), host);
    ...
    public static IReadOnlyList<string> Run(
        ...
        HostKind host = HostKind.Ebcdic)
    {
        var program = new Cbstm03a(Cbstm03b.Create(db, host), host);
        program.Execute(stmtPath, htmlPath);
        return program.Sysout;
    }
