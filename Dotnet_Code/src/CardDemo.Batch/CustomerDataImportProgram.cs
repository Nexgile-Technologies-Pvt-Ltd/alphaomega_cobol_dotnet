...
/// </list>
/// </remarks>
public sealed class CustomerDataImportProgram(CustomerDataImportProgram.Context ctx)
{
    ...
    /// <summary>
    /// Inputs for <see cref="CustomerDataImportProgram"/> over the relational data layer.
    /// </summary>
