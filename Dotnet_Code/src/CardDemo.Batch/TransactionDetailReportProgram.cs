...
/// </list></para>
/// </remarks>
public sealed class TransactionDetailReportProgram
{
    ...
    private TransactionDetailReportProgram(HostKind host) => _host = host;
    ...
    {
        var program = new TransactionDetailReportProgram(host);
