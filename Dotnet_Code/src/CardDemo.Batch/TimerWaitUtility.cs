...
public sealed class TimerWaitUtility
{
    ...
    /// </param>
    public static TimerWaitUtility Run(string sysin, IWaiter? waiter = null, HostKind host = HostKind.Ebcdic)
    {
        waiter ??= RealWaiter.Instance;
        var program = new TimerWaitUtility();
