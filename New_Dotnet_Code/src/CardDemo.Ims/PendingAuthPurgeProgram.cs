...
/// </remarks>
public sealed class PendingAuthPurgeProgram
{
    ...
    /// code). A <c>9999-ABEND</c> sets <see cref="PendingAuthPurgeProgramResult.ReturnCode"/> to 16 and stops the run
    ...
    public static PendingAuthPurgeProgramResult Run(
...
/// <summary>
/// The result of a <see cref="PendingAuthPurgeProgram"/> run: the SYSOUT (DISPLAY) lines in order and the batch
...
public sealed record PendingAuthPurgeProgramResult(IReadOnlyList<string> Sysout, int ReturnCode);
