...
/// <para>Date validation uses <see cref="DateValidationUtility"/> (the LE <c>CSUTLDTC</c> stand-in) exactly as the COBOL
...
/// </list>
/// </remarks>
public sealed class TransactionAddProgram : ITransactionHandler
{
    // =============================================================================================
    ...
    /// </summary>
    public TransactionAddProgram(RelationalDb db) => _db = db;
